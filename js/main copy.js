...
document.addEventListener('DOMContentLoaded', function() {
    new Typed('.home_title #subtitle', {
        strings: ['Дизайн и разработка стильных сайтов.', 'Уникальный инструмент для увеличения прибыли вашего бизнеса', 'Услуги веб студии Digital Agency'],
        typeSpeed: 50,
        backSpeed: 20,
        smartBackspace: true,
        loop: true
    ...
    $('.popup-link').magnificPopup({
        ...
        image: {
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>Digital Agency</small>';
            }
        }
    });	
